...
```
<img src="{% asset_path postgis-normalize-geometry/_assets/example1a.png %}" alt="example1a" style="width:100%; max-width:800px;">
...
```
<img src="{% asset_path postgis-normalize-geometry/_assets/example1b.png %}" alt="example1b" style="width:100%; max-width:800px;">
...
<img src="{% asset_path postgis-normalize-geometry/_assets/example3.png %}" alt="example3" style="width:100%; max-width:1000px;">
