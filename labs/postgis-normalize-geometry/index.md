...
```
{% img postgis-normalize-geometry/_assets/example1a.png style:'width:100%; max-width:1536px;' %}
...
```
{% img postgis-normalize-geometry/_assets/example1b.png style:'width:100%; max-width:1536px;' %}
